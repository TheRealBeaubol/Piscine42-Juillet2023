...
/*   Updated: 2023/08/03 11:41:35 by lboiteux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <unistd.h>

void	convert_to_hex(unsigned long long int addr, int cond)
{
	char	*base;
...
void	print_addr(unsigned long long int addr)
{
...
void	print_values(unsigned char *car, unsigned int size)
{
	unsigned int	i;
